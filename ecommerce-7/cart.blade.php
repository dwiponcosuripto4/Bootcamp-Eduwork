                ...
                <div class="row g-3">
                    <div class="col-lg-8">
                        @foreach ($cartItems as $cartItem)
                            @php
                                $lineTotal = (float) $cartItem->product->price * (int) $cartItem->quantity;
                            @endphp
                            <div class="cart-item">
                                <div class="row g-3 align-items-center">
                                    <div class="col-auto">
                                        <img src="{{ asset('images/' . $cartItem->product->image) }}"
                                            alt="{{ $cartItem->product->name }}" class="cart-img"
                                    ...
                                    <div class="col">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h6 class="mb-1 fw-semibold">{{ $cartItem->product->name }}</h6>
                                                <p class="mb-2 small text-muted">
                                                    <span
                                                        class="badge bg-light text-dark">{{ $cartItem->product->product_category?->name ?? 'Umum' }}</span>
                                                </p>
                                                <p class="mb-0 fw-bold" style="color: #E53935; font-size: 1.1rem;">
                                                    Rp {{ number_format((float) $cartItem->product->price, 0, ',', '.') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
